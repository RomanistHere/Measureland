...
const addGeoToUser = async (userID, ratingID, geoID, activeRatings) =>
...
const saveAndUpdateRefs = async (userID, geoID, comment, username, averageRating, rating, isPersonalExperience, timeline, activeRatings) => {
	...
	const userResult = await addGeoToUser(userID, ratingID, geoID, activeRatings);
	...
	try {
		...
		if (geo) {
			...
			try {
				...
				await saveAndUpdateRefs(userID, geoUpdated._id, comment, user.username, averageRating, rating, isPersonalExperience, timeline, activeRatings);
			...
			try {
				...
				await saveAndUpdateRefs(userID, geoSaved._id, comment, user.username, averageRating, rating, isPersonalExperience, timeline, activeRatings);
