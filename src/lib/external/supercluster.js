...
Supercluster.prototype._cluster = function _cluster (points, zoom) {
    ...
    for (var i = 0; i < points.length; i++) {
        ...
        var ratingOrigin = p.rating || 0
        var ratingSum = ratingOrigin
        ...
        if (numPoints >= minPoints) { // enough points to form a cluster
            ...
            p.parentId = id;
            clusters.push(createCluster(wx / numPoints, wy / numPoints, id, numPoints, clusterProperties, ratingSum));
...
function createCluster(x, y, id, numPoints, properties, ratingSum) {
    return {
...
function createPointCluster(p, id) {
    ...
    var rating = p.properties.averageRating;
    var x = ref[0];
    var y = ref[1];
    return {
        rating: rating,
