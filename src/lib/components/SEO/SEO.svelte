...
<svelte:head>
    ...
    <meta http-equiv="Content-Security-Policy" content="
        base-uri 'self';
        connect-src 'self' {API_DOMAIN} plausible.io *.openstreetmap.org *.sentry.io geocode-api.arcgis.com api.waqi.info api.openweathermap.org en.wikipedia.org eu1.locationiq.com;
        default-src 'self';
        font-src 'self' data:;
